...
package com.gjcar.view.wheelview;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = Color.parseColor("#1B8CCE");;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = Color.parseColor("#B4AAA9");
