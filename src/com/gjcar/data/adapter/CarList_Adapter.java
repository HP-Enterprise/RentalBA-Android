	...
	public class MyOnClickListener implements OnClickListener{
		...
		public void onClick(View view) {
			...
			if(list.get(position).vendorStorePriceShowList.get(0).avgShow.activityShows != null){
				...
				Public_Param.order_paramas.activity_payment = list.get(position).vendorStorePriceShowList.get(0).avgShow.activityShows.get(activity_position[position]).payment;
