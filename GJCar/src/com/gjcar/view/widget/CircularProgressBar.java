...
public class CircularProgressBar extends View {
	...
	private int mBackgroundColor = Color.parseColor("#e2e2e2");
	private int mPrimaryColor = Color.parseColor("#ffffff");
	private float mStrokeWidth = 10F;
	
	private float startAngle = 90;//-90;//开始的角度
	/**
	 * 进度条改变监听
	 * 
	...
	protected synchronized void onDraw(Canvas canvas) {
		...
		canvas.drawArc(mRectF, startAngle, getRateOfProgress() * 360, false, mPaint);
		canvas.save();
	}
