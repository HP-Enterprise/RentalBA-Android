...
public class CarList_Helper {

	/**
	 * 获取数据
	 */
	public <T> void initData(String method, Context context, String api, JSONObject jsonObject, RequestParams params, final Handler handler, final int what, int String_Object, final TypeReference<T> type) {
		...
		httpClient.get(url, params, new AsyncHttpResponseHandler() {
			...
			public void onSuccess(int arg0, Header[] arg1, byte[] data) {
				...
				if(status){
					...
					HandlerHelper.sendStringObject(handler, what, HandlerHelper.Ok, JSON.parseObject(content, type));	
