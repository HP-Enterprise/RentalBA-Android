...
import com.gjcar.data.service.FreeRideOrderHelper;
...
public class Activity_FreeRide_Order_Detail extends Activity{
	...
	private void init(){
		...
		if(carTrunk == null || carTrunk.equals("null")){
			
			carTrunk = "";
		}
		
		a_note.setText(Public_Param.order.carGroupstr+"/"+carTrunk+"/"+Public_Param.order.seatsStr);
	...
	public void onClick(View view){
		...
		switch (view.getId()) {
			...
			case R.id.cancle:
				...
				ibuilder = new CustomDialog.Builder(Activity_FreeRide_Order_Detail.this);
				...
				ibuilder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface arg0, int arg1) {
						...
						String api = "api/freeRideOrder/"+Public_Param.order.orderId+"/cancelOrder";

						new HttpHelper().initData(HttpHelper.Method_Put, Activity_FreeRide_Order_Detail.this, api, null, null, handler, Cancle_Order, 2, null);		
