...
public class Activity_Store_Select extends Activity{
			...
			public void handleMessage(Message msg) {
				...
				switch (msg.what) {
					...
					case KeyWord:
						...
						TencentMapHelper.suggestion(Activity_Store_Select.this, "武汉", msg.getData().getString("message"), handler, Search);
						break;
...
//							ListViewHelper.flush((List<Map<String,Object>>)msg.obj);
							ListViewHelper.SimpleAdapter(Activity_Store_Select.this, listview_search, (List<Map<String,Object>>)msg.obj, R.layout.listview_area_item, new String[]{"title", "address"}, new int[]{R.id.title,R.id.address});
