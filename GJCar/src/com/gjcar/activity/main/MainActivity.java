	...
	private void showShareDialog(){
		...
		dialog.setListener(new ShareImageDialog.ClickListener() {
			...
			public void allClick() {
				IntentHelper.startActivity_StringExtras(MainActivity.this, WebActivity.class, new String[]{"title","fragment","url"}, new String[]{"活动详情","action_detail",Public_Api.appWebSite_Share+"activity/mobile/nationalDay/index.html"});
